...
- **[28. BST - Search](./113-bst_search.c)**
...
- **[29. BST - Remove](./114-bst_remove.c)**
...
- **[31. Is AVL](./120-binary_tree_is_avl.c)**
...
- **[33. AVL - Array to AVL](./122-array_to_avl.c)**
	...
	**[14-binary_tree_balance.c](./14-binary_tree_balance.c)**
	...
	- Your files 121-avl_insert.c, 0-binary_tree_node.c, 14-binary_tree_balance.c, 103-binary_tree_rotate_left.c and 104-binary_tree_rotate_right.c will be compiled during the correction- Your function must return a pointer to the new root node of the tree once rotated
...
- **[37. Is Binary heap](./130-binary_tree_is_heap.c)**
...
- **[39. Heap - Array to Binary Heap](./132-array_to_heap.c)**
...
- **[40. Heap - Extract](./133-heap_extract.c)**
